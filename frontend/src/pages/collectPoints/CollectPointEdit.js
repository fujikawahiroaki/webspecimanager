    ...
    <Edit actions={<CollectPointEditActions/>} {...props} title="採集地点">
        <TabbedForm>
            <FormTab label="地名情報">
                ...
                <TextInput source="japanese_place_name_detail" label="日本語地名(詳細) 標本との紐付けの際の検索に利用されるので、検索しやすい内容にしてください" helperText="50字以内" parse={identity} resettable validate={[minLength(0), maxLength(50)]}/>
            </FormTab>

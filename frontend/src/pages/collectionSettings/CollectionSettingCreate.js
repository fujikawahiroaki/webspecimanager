    ...
    <Create actions={<CollectionSettingCreateActions/>} {...props} title="コレクション設定">
        <TabbedForm redirect='list'>
            <FormTab label="設定">
                ...
                <NumberInput source="latest_collection_code" label="標本IDの最新番号(標本登録時はこの値の+1が標本IDとなります)" defaultValue={0} helperText='半角数字18桁以内(新規にコレクションを作成する場合は0を入力してください)' validate={[minValue(0), maxValue(999999999999999999)]}/>
            </FormTab>
            <FormTab label="備考">
